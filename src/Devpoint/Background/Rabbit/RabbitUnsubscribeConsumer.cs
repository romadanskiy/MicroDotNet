...
public class RabbitUnsubscribeConsumer : BackgroundService
{
    ...
    private readonly string _queue = Environment.GetEnvironmentVariable("RABBIT_QUEUE_UNSUBSCRIBE")!;

    public RabbitUnsubscribeConsumer(SubscriptionsStorage storage)
    {
        _storage = storage;
    ...
    protected override Task ExecuteAsync(CancellationToken cancellationToken)
    {
        ...
        consumer.Received += (_, ea) =>
        {
            ...
            _storage.RemoveSubscription(record);
